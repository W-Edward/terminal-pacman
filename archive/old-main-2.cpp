...
bool haveCollided(int y, int x, Ghost &Blinky, Ghost &Pinky, Ghost &Inky, Ghost &Clyde){ // checks if pacman has collided with either of the ghosts
    if ((x == Blinky.getX()) && (y == Blinky.getY())){
        return true;
